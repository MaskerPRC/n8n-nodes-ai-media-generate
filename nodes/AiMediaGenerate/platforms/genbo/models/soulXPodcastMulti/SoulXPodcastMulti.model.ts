...
export class SoulXPodcastMultiModel extends BaseGenboModel {
	getConfig(): ModelConfig {
		return {
			name: 'soulXPodcastMulti',
			displayName: 'SoulX-Podcast-Multi',
	...
	getInputSchema(): INodeProperties[] {
		return [
			...
			},
			{
				...
				description: 'The URL of the first audio file to use for audio generation (optional)',
			},
			{
				...
				description: 'The URL of the second audio file to use for audio generation (optional)',
			},
			{
