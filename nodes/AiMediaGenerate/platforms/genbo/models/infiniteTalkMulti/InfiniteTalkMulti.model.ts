...
export class InfiniteTalkMultiModel extends BaseGenboModel {
	getConfig(): ModelConfig {
		return {
			name: 'infiniteTalkMulti',
			displayName: 'InfiniteTalk Multi',
		...
		return [
			{
				...
				default: '',
				required: true,
				description: 'The text prompt describing the video generation',
			},
			{
				...
				default: '',
				required: true,
				description: 'The URL of the audio file to use for video generation',
			},
			{
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'The URL of the second audio file (optional)',
			},
			{
				displayName: 'Multi Audio Type',
				...
				default: 'add',
				description: 'The type of multi-audio operation',
			},
		];
	}
	...
	async buildRequestParams(): Promise<IDataObject> {
		...
		const multiAudioType = this.executeFunctions.getNodeParameter('multi_audio_type', this.itemIndex) as string;
		if (multiAudioType) {
			params.multi_audio_type = multiAudioType;
		}
