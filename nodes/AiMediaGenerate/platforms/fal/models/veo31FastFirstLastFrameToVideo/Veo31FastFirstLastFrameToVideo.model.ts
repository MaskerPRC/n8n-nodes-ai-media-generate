...
export class Veo31FastFirstLastFrameToVideoModel extends BaseFalModel {
	getConfig(): ModelConfig {
		return {
			name: 'veo31FastFirstLastFrameToVideo',
			displayName: 'Veo 3.1 Fast First-Last-Frame-to-Video',
	...
	getInputSchema(): INodeProperties[] {
		return [
			...
			},
			{
				...
				required: true,
				description:
					'URL of the first frame of the video. Supports publicly accessible URLs or base64 data URIs. Input images up to 8MB in size.',
			},
			{
				...
				required: true,
				description:
					'URL of the last frame of the video. Supports publicly accessible URLs or base64 data URIs. Input images up to 8MB in size.',
			},
			{
	...
	protected processSyncResponse(response: IDataObject): IDataObject {
		// Veo 3.1 Fast First-Last-Frame-to-Video 不支持同步请求
		return response;
	}
