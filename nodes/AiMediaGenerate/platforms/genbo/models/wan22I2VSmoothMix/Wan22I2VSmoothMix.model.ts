...
export class Wan22I2VSmoothMixModel extends BaseGenboModel {
	getConfig(): ModelConfig {
		return {
			name: 'wan22I2VSmoothMix',
			displayName: 'Wan2.2-I2V-Smooth-Mix',
	...
	getInputSchema(): INodeProperties[] {
		return [
			...
			},
			{
				...
				default: '',
				required: true,
				description: 'The URL of the image to generate video from',
			},
			{
			...
			},
			{
				...
				type: 'number',
				default: 8,
				description: 'The shift parameter for video generation',
			},
			{
				...
				type: 'number',
				default: 1,
				description: 'The guidance scale for video generation',
			},
			{
				...
				type: 'number',
				default: 1,
				description: 'The second guidance scale for video generation',
			},
			{
			...
			},
			{
				...
				default: '',
				description: 'The negative prompt to avoid certain elements in the video',
			},
		];
	}
	...
	async buildRequestParams(): Promise<IDataObject> {
		...
		const framesPerSecond = this.executeFunctions.getNodeParameter(
			'frames_per_second',
			this.itemIndex,
		) as number;
