...
export class Gemini3ProImageT2IModel extends BaseFalModel {
	getConfig(): ModelConfig {
		return {
			name: 'gemini3ProImageT2I',
			displayName: 'Gemini 3 Pro Image (Text-to-Image)',
	...
	protected processSyncResponse(response: IDataObject): IDataObject {
		// Gemini 3 Pro Image T2I 不支持同步请求
		return response;
	}
