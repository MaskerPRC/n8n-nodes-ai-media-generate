...
export class Wan22AnimateReplaceModel extends BaseGenboModel {
	getConfig(): ModelConfig {
		return {
			name: 'wan22AnimateReplace',
			displayName: 'Wan2.2-14B-Animate-replace',
	...
	async buildRequestParams(): Promise<IDataObject> {
		const params: IDataObject = {
			model: 'Wan2.2-14B-Animate-replace',
		};
	...
	protected processSyncResponse(response: IDataObject): IDataObject {
		// Wan2.2-14B-Animate-replace 不支持同步请求
		return response;
	}
