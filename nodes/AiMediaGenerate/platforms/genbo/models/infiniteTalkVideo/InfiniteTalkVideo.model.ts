...
export class InfiniteTalkVideoModel extends BaseGenboModel {
	getConfig(): ModelConfig {
		return {
			name: 'infiniteTalkVideo',
			displayName: 'InfiniteTalk-video',
		...
		return [
			{
				...
				default: '',
				required: true,
				description: 'The text prompt describing the video sound replacement',
			},
			{
				...
				default: '',
				required: true,
				description: 'The URL of the audio file to replace the sound in the video',
			},
			{
	...
	async buildRequestParams(): Promise<IDataObject> {
		...
		const cfg = this.executeFunctions.getNodeParameter('cfg', this.itemIndex) as number;
