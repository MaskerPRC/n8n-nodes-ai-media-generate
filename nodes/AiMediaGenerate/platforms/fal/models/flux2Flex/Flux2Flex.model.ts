...
export class Flux2FlexModel extends BaseFalModel {
	...
	getInputSchema(): INodeProperties[] {
		return [
			...
			},
			{
				...
				default: '2',
				description: 'The safety tolerance level for the generated image. 1 being the most strict and 5 being the most permissive. This property is only available through API calls.',
			},
			{
